...
<context>
    ...
    <schedule_history> (last 10 rounds, most recent call last)
        ...
        Task 2 | Run baseline benchmark | ❌ not completed
...
{"action": "execute", "task_id": 4, "reasoning": "Run integration validation with the optimized algorithm"}
