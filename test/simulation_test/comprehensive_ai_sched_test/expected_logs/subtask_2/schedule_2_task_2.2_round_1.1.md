# Task 2.2: Process data — Round 1.1
...
<instructions>
    ...
    Check the command outputs in redirected files or "logs/<SESSION>/lr_tasks/lr_2.2.2_output.log" and continue working if it has already finished.
