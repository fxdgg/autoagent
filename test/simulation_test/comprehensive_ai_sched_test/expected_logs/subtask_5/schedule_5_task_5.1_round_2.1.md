# Task 5.1: Prepare fallback scenario — Round 2.1
...
<instructions>
    ...
    Check the command outputs in redirected files or "logs/<SESSION>/lr_tasks/lr_5.5.1_output.log" and continue working if it has already finished.
