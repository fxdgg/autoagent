# Task 5.2: Run fragile transformation — Round 1.1
...
<instructions>
    ...
    Check the command outputs in redirected files or "logs/<SESSION>/lr_tasks/lr_5.5.2_output.log" and continue working if it has already finished.
