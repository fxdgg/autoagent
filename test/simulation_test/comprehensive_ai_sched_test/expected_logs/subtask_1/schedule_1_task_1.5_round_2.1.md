# Task 1.5: Commit results — Round 2.1
...
<instructions>
    ...
    Check the command outputs in redirected files or "logs/<SESSION>/lr_tasks/lr_1.1.5_output.log" and continue working if it has already finished.
...
I committed the improved results:
