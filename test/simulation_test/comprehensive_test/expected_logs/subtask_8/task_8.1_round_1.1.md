# Task 8.1: Registry setup — Round 1.1
...
<instructions>
    ...
    Check the command outputs in redirected files or "logs/<SESSION>/lr_tasks/lr_8.1_output.log" and continue working if it has already finished.
