# Task 1.3: Core processing — Round 1.2
...
<instructions>
    ...
    Check the command outputs in redirected files or "logs/<SESSION>/lr_tasks/lr_1.3_output.log" and continue working if it has already finished.
